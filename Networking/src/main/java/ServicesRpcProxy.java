...
public class ServicesRpcProxy implements IService{
    ...
    @Override
    public void login(Angajat user, IObserver client) throws ServiceException {
        if (!isInitialized) {
    ...
    @Override
    public void logout(Angajat user, IObserver client) throws ServiceException {
        UserDTO udto = DTOUtils.getDTO(user);
    ...
    @Override
    public Spectacol[] findAllShows() throws ServiceException {
        if (!isInitialized) {
            initializeConnection();
            this.isInitialized = true;
        }
        ...
        Spectacol[] shs = DTOUtils.getFromDTO(shDTOS);
    ...
    @Override
    public Spectacol ticketsSold(Spectacol show, Bilet t) throws ServiceException {
    ...
    private void handleUpdate(Response response) {
        ...
        if (response.type() == ResponseType.UPDATED_SHOWS) {
            Spectacol sh = DTOUtils.getFromDTO((ShowDTO) response.data());
            try {
